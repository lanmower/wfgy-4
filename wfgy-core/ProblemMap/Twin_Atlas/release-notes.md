...
2. Use it as the release-oriented companion to the roadmap, quickstart, and FAQ.
...
4. Runtime README
5. Evidence Hub
6. This release notes page
7. Bridge and demo pages
...
This is a major milestone because Twin Atlas no longer reads only like architecture talk.
It now reads like a governed engine with a visible runtime spine.
...
Twin Atlas is no longer relying only on conceptual argument.
It now has an evidence-facing structure, raw runs, and methodology boundary.
