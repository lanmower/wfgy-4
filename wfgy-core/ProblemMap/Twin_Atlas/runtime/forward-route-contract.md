...
Document role:
This page is the public forward-route contract page for the runtime layer of WFGY 4.0 Twin Atlas Engine.

What this page is for:
1. Explain what the route-first contract is inside the Twin Atlas runtime.
2. Show what the Forward Atlas side must preserve before any stronger governance step happens.
3. Help readers understand why route quality, fit honesty, broken invariant, and misrepair shadow matter so much.
4. Provide a public runtime-facing entry into the route contract without dumping the full raw ontology.
...
4. It is not the final authorization layer.
5. It is not proof that every future routing subtype is already fully finalized here.

Reading order:
1. Read the Twin Atlas README first.
2. Read the Runtime README and Runtime Constitution second.
3. Read this page when you want to understand the route-first runtime contract.
4. Then move into Bridge, Inverse Governance Contract, and State Machine and Output.

Important boundary:
This page presents the public route-first contract of Twin Atlas.
It does not replace the full Forward Atlas family corpus.
It also does not grant authorization or final repair legality by itself.
...
It does **not** own final authorization.
It does **not** own public ceiling.
It does **not** own final repair legality.
...
It is not decorative nuance.
It is preserved pressure.
...
It matters because a lot of systems do not only miss the right route.
They also confidently choose the wrong first move.
...
### 🫧 `overlay`
This is optional refinement only.
It must never replace the main route.
...
Not the prettiest route.
Not the most dramatic route.
Not the most marketable route.
Not the most specific-looking route.

The highest **honest** route resolution.

That is why Twin Atlas values:

- honest family-level fit
over
