...
Document role:
This page is the public constitution page for the runtime layer of WFGY 4.0 Twin Atlas Engine.

What this page is for:
1. Present the Twin Atlas runtime constitution as the inspectable public engine skeleton.
2. Explain what the runtime constitution contains and why it matters.
3. Help readers understand the role of Forward Atlas, Bridge, Inverse Atlas, state logic, and sealing inside one coherent runtime direction.
4. Provide a clean entry point before readers move into deeper runtime subpages.

What this page is not:
1. It is not the flagship landing page.
2. It is not the full evidence hub.
3. It is not a generic prompt tricks page.
4. It is not proof that every possible runtime branch is already complete.
5. It is not the hidden internal substrate of the whole system.

Reading order:
1. Read the Twin Atlas README first.
2. Read the Runtime README second.
3. Read this page if you want the clearest public view of the engine constitution.
4. Then move into Bridge, Inverse Governance Contract, State Machine and Output, or Seal and Audit depending on your goal.

Important boundary:
This page presents the public runtime constitution of Twin Atlas.
It does not claim that every future operating detail, every extension branch, or every hidden internal reasoning layer is already fully exposed or finalized here.
...
- [Forward Route Contract](./forward-route-contract.md)
