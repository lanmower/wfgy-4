...
Document role:
This page is the launch summary page for WFGY 4.0 Twin Atlas Engine.

What this page is for:
1. Give readers the fastest serious summary of what WFGY 4.0 is.
2. Show why Twin Atlas matters without forcing readers to open the full document stack first.
3. Present the product identity, core architecture, evidence direction, and current release boundary in one place.
4. Act as a public-facing summary page for launch, sharing, onboarding, and external explanation.

What this page is not:
1. It is not the flagship landing page.
2. It is not the full runtime constitution.
3. It is not the full evidence archive.
4. It is not the full roadmap.
5. It is not a universal benchmark claim page.

Reading order:
1. Read this page if you want the fastest serious overview.
2. Then go to the Twin Atlas README for the full flagship story.
3. Use Quickstart if you want guided reading paths.
4. Use Evidence Hub if you want proof first.
5. Use Runtime README if you want engine structure first.

Important boundary:
This page is a public launch summary.
It is designed to make the current WFGY 4.0 release surface legible quickly.
It does not claim that every future coupling layer, every runtime detail, or every formalization step is already fully complete.
