...
Document role:
This page is the public entry page for the Advanced Clean Protocol inside the WFGY 4.0 evidence layer.

What this page is for:
1. Explain why a cleaner evaluation path is needed in addition to the Basic Repro Demo.
2. Show how the Advanced Clean Protocol reduces common criticism such as same-context contamination or simulated before-pass behavior.
3. Help readers understand the stricter public-facing protocol path without turning the page into an academic-only appendix.
4. Provide the stable public positioning for the cleaner evidence track of WFGY 4.0.

What this page is not:
1. It is not the flagship landing page.
2. It is not the fast demo page.
3. It is not the full raw archive.
4. It is not a universal benchmark claim.
5. It is not proof that every future evaluation branch is already finalized.

Reading order:
1. Read the Twin Atlas README first.
2. Read the Evidence Hub and Results Summary next.
3. Read the Basic Repro Demo before this page if you want the fast path first.
4. Read this page when you want the cleaner and more blackhat-resistant evaluation path.

Important boundary:
The Advanced Clean Protocol is a stricter evidence path for WFGY 4.0.
It is designed to improve separation, reduce protocol criticism, and increase external credibility.
It should not be mistaken for a universal benchmark or the final endpoint of all future evaluation design.
...
## 🧪 What the protocol is trying to protect
...
### 🟨 Path 3: Optional generic cautious control
...
## 📊 What stays fixed across the protocol
...
## 🛡️ Why this page matters for blackhat review
...
## 🧾 What should eventually be attached to this page
