...
Document role:
This page is the public entry page for the Basic Repro Demo inside the WFGY 4.0 evidence layer.

What this page is for:
1. Explain the purpose of the fast reproducible demo track.
2. Help new readers understand what the Basic Repro Demo is and what it is not.
3. Provide the cleanest beginner-friendly explanation of how to quickly see the WFGY 4.0 before/after shift.
4. Support README, screenshots, social sharing, and first-contact public understanding.

What this page is not:
1. It is not the full protocol page.
2. It is not the full benchmark archive.
3. It is not the cleanest possible evaluation design.
4. It is not proof of universal superiority across all models and all tasks.
5. It is not a replacement for the Advanced Clean Protocol.

Reading order:
1. Read the Twin Atlas README first.
2. Read the Evidence Hub and Results Summary next.
3. Read this page when you want the fastest reproducible demo path.
4. Move to Advanced Clean Protocol later if you want a stricter evaluation structure.

Important boundary:
The Basic Repro Demo is a fast public-facing reproducibility surface.
It is designed to make the governance shift visible quickly.
It should not be mistaken for the final scientific endpoint of the whole WFGY 4.0 evidence layer.
