...
Document role:
This page is the beginner-friendly quickstart guide for WFGY 4.0 Twin Atlas Engine.

What this page is for:
1. Help new readers understand where to start.
2. Show the fastest reading paths for different goals.
3. Prevent readers from getting lost inside the full WFGY 4.0 document family.
4. Turn the Twin Atlas release surface into something approachable for first-time users.

What this page is not:
1. It is not the flagship landing page.
2. It is not the full runtime constitution.
3. It is not the evidence summary page.
4. It is not the full protocol page.
5. It is not a benchmark claim page.

Reading order:
1. Read the Twin Atlas README first.
2. Use this page next if you are not sure where to go.
3. Pick the path that matches what you want:
   - practical diagnosis
   - governance
   - runtime structure
   - evidence and demos
...
Important boundary:
This page is a guided entry surface.
It is designed to reduce confusion and lower the first-reading burden.
It does not replace the deeper pages of WFGY 4.0.
...
### Read in this order:
1. [Twin Atlas README](./README.md)
2. [Related Documents](./related-documents.md)
3. [Troubleshooting Atlas / Forward Atlas](../wfgy-ai-problem-map-troubleshooting-atlas.md)
4. [Bridge README](./Bridge/README.md)
5. [Results Summary](./evidence/results-summary.md)
...
### Read in this order:
1. [Twin Atlas README](./README.md)
2. [Status and Boundaries](./status-and-boundaries.md)
3. [Inverse Atlas README](../Inverse_Atlas/README.md)
4. [Inverse Governance Contract](./runtime/inverse-governance-contract.md)
5. [Results Summary](./evidence/results-summary.md)
...
3. [Why Bridge Exists](./Bridge/why-bridge-exists.md)
4. [Runtime README](./runtime/README.md)
5. [Twin Atlas Runtime Constitution](./runtime/twin-atlas-runtime-constitution.md)
6. [State Machine and Output](./runtime/state-machine-and-output.md)
7. [Seal and Audit](./runtime/seal-and-audit.md)
...
### Read in this order:
1. [Twin Atlas README](./README.md)
2. [Evidence Hub](./evidence/README.md)
3. [Results Summary](./evidence/results-summary.md)
4. [Methodology Boundary](./evidence/methodology-boundary.md)
5. [Raw Runs](./evidence/raw-runs/)
...
### Read in this order:
1. [Twin Atlas README](./README.md)
2. [Results Summary](./evidence/results-summary.md)
