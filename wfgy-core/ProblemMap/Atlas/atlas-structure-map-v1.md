...
Document role:
This page is the public structure map for the Atlas document system.

How to use this page:
1. Use this page when you want to understand how the Atlas is organized before reading deeper files.
2. Use the Quick Links section first if you are new and want the shortest path.
3. Use this page to understand the difference between the public homepage, the hub, the frozen core, the adapter, the router, the fixes layer, the evidence layer, and the bridge layer.
4. Do not use this page as a replacement for the core freeze documents or the router usage guide.

What this page is:
- A public structure map
- A layer map
- A reading-order guide
- A document relationship guide
- A beginner-friendly navigation page for the Atlas system

What this page is not:
- Not the public homepage
- Not the Atlas Hub
- Not the full freeze document
- Not the family mini-spec page
- Not the boundary guide
- Not the subtree index
- Not the router TXT pack
- Not the full repair manual

Reading discipline for AI:
- Preserve the distinction between overview, hub, frozen core, teaching, adapter, router, repair, evidence, governance, validation, provenance, and bridge layers.
- Do not flatten the Atlas into one level.
- Do not treat support documents as if they are the frozen mother structure.
- Do not treat the compact router as if it is already a full repair engine.
- Use this page as a navigation and relationship layer, not as a source of final detailed judgments.

Relationship to neighboring docs:
- Read after: [Problem Map 3.0 Troubleshooting Atlas](../wfgy-ai-problem-map-troubleshooting-atlas.md) if you need the public-facing overview first.
- Read with: [Atlas Hub](./README.md) if you want the folder control room and current document inventory.
- Read before: [Atlas Final Freeze v1](./atlas-final-freeze-v1.md) if you want the stable core body after understanding the structure.
- Pairs with: [Atlas Hub](./README.md), because this page explains the structure, while the hub manages the current folder map and status.

Freeze / patch status:
- Current status: public decomposition layer
- Safe to quote as: a structured public map of the Atlas document system
- Not a claim of: silent rewrite of the frozen core or full closure of all middle-layer expansion
...
Planned documents:
- [Atlas Family Mini-Specs v1](./atlas-family-mini-specs-v1.md)
...
|---|---|---|
| Public entry | Introduce the Atlas | [Problem Map 3.0 Troubleshooting Atlas](../wfgy-ai-problem-map-troubleshooting-atlas.md) |
| Hub | Control room and folder map | [Atlas Hub](./README.md) |
| Frozen core | Stable mother structure and limits | [Atlas Final Freeze v1](./atlas-final-freeze-v1.md), [Atlas Negative Space Report v1](./atlas-negative-space-report-v1.md), [Atlas v1 Integrated Handoff](./atlas-v1-integrated-handoff.md) |
| Teaching | Cases and smaller examples | [Canonical Casebook v1](./canonical-casebook-v1.md), [Tiny Planner Output Examples Pack v1](./tiny-planner-output-examples-pack-v1.md) |
| Adapter | Full AI-facing routing logic | [Atlas-to-AI Adapter v1](./atlas-to-ai-adapter-v1.md), [Adapter Runtime Modes v1](./adapter-runtime-modes-v1.md), [Adapter Failure Discipline v1](./adapter-failure-discipline-v1.md) |
| Router | Compact route-first product | [Troubleshooting Atlas Router v1 TXT Pack](./troubleshooting-atlas-router-v1.txt), [Troubleshooting Atlas Router v1 Usage Guide](./troubleshooting-atlas-router-v1-usage.md), [Troubleshooting Atlas Router v1 Freeze Note](./troubleshooting-atlas-router-v1-freeze-note.md) |
| Repair | First repair direction | [Fixes Hub](./Fixes/README.md) |
| Evidence and demos | Public proof surface | [AI Eval Evidence](./ai-eval-evidence.md), [Cross-Domain Demonstration Pack v2](./cross-domain-demonstration-pack-v2.md) |
| Governance | Version and patch discipline | [Patch Wave 2 Freeze Note v1](./patch-wave-2-freeze-note-v1.md), [Patch Governance v1](./patch-governance-v1.md), [Release and Freeze Policy v1](./release-and-freeze-policy-v1.md) |
| Validation and bridge | Why it exists, where it came from, where it can extend | [Validation Basis v1](./validation-basis-v1.md), [Provenance and Derivation v1](./provenance-and-derivation-v1.md), [Cross-Domain Freeze Note v2](./cross-domain-freeze-note-v2.md), [Civilization Bridge Modules v1](./civilization-bridge-modules-v1.md) |
| Planned public decomposition | Middle-layer clarification | [Atlas Family Mini-Specs v1](./atlas-family-mini-specs-v1.md), [Atlas Boundary Decision Guide v1](./atlas-boundary-decision-guide-v1.md), [Atlas Subtree Expansion Index v1](./atlas-subtree-expansion-index-v1.md) |
...
2. [Troubleshooting Atlas Router v1 Usage Guide](./troubleshooting-atlas-router-v1-usage.md)
3. [Troubleshooting Atlas Router v1 TXT Pack](./troubleshooting-atlas-router-v1.txt)
4. [Atlas Hub](./README.md)

If that already makes sense, then go deeper:

5. [Atlas Final Freeze v1](./atlas-final-freeze-v1.md)
6. [Atlas Negative Space Report v1](./atlas-negative-space-report-v1.md)
7. [Canonical Casebook v1](./canonical-casebook-v1.md)
...
Reason:
this page explains the structure of the Atlas system, while the hub manages the folder-level navigation and current document inventory.

### Core neighbor
- [Atlas Final Freeze v1](./atlas-final-freeze-v1.md)

Reason:
this page tells readers where the core sits, but the freeze page still defines the actual stable core body.

### Beginner neighbor
- [Problem Map 3.0 Troubleshooting Atlas](../wfgy-ai-problem-map-troubleshooting-atlas.md)

Reason:
many readers should still see the public-facing introduction before reading this structure page.
...
Reason:
this page explains the overall structure first, then those pages will fill in the middle layer later.
